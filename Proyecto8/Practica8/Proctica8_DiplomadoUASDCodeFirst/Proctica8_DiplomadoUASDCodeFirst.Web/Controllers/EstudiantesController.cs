...
namespace Proctica8_DiplomadoUASDCodeFirst.Web.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EstudianteID,Nombre,Apellidos,Fecha_Inscripcion")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EstudianteID,Nombre,Apellidos,Fecha_Inscripcion")] Estudiante estudiante)
        {
            if (ModelState.IsValid)
            {
