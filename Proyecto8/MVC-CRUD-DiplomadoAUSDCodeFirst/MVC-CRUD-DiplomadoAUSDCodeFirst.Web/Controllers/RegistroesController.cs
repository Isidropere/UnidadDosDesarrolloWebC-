...
namespace MVC_CRUD_DiplomadoAUSDCodeFirst.Web.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        {
            var registros = db.Registros.Include(r => r.Empleado);
        ...
        public ActionResult Create([Bind(Include = "RegistroID,Sueldo,DepartemantoID,EmpleadoID")] Registro registro)
        {
            ...
            ViewBag.EmpleadoID = new SelectList(db.Empleados, "EmpleadoID", "Nombre", registro.EmpleadoID);
            return View(registro);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RegistroID,Sueldo,DepartemantoID,EmpleadoID")] Registro registro)
        {
            if (ModelState.IsValid)
            {
